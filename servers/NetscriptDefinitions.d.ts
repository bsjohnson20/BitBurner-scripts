 ...
 * @public
 */
declare type _ValueOf<T> = T[keyof T];

// Imported to allow editor completions
 ...
 * @public
 */
declare interface StudyTask extends BaseTask {
  type: "CLASS";
  classType: string;
  location: LocationName;
}
 ...
 * @public
 */
declare interface CompanyWorkTask extends BaseTask {
  type: "COMPANY";
 ...
 * @public
 */
declare interface CreateProgramWorkTask extends BaseTask {
  type: "CREATE_PROGRAM";
  programName: string;
}
 ...
 * @public
 */
declare interface CrimeTask extends BaseTask {
  type: "CRIME";
  crimeType: CrimeType;
}
 ...
 * @public
 */
declare interface FactionWorkTask extends BaseTask {
  type: "FACTION";
  factionWorkType: FactionWorkType;
  factionName: FactionName;
}
 ...
 * @public
 */
declare interface GraftingTask extends BaseTask {
  type: "GRAFTING";
  augmentation: string;
  /**
 ...
 * @public
 */
declare type Task = StudyTask | CompanyWorkTask | CreateProgramWorkTask | CrimeTask | FactionWorkTask | GraftingTask;
 ...
 * @public
 */
declare interface BitNodeOptions extends BitNodeBooleanOptions {
 ...
 * @public
 */
declare interface BitNodeBooleanOptions {
 ...
 * @public
 */
declare type BladeburnerActionName =
 ...
 * @public
 */
declare type BladeburnerActionTypeForSleeve =
...
/** @public */
declare type DarknetResult = { success: boolean; code: DarknetResponseCode; message: string };

/**
 * Darknet server data.
 * @public
 */
declare interface DarknetServerData {
  /** Hostname. Must be unique */
  hostname: string;
  /** IP Address. Must be unique */
  ip: string;
...
declare interface NS {
   ...
   * ```js
   * declare async function log(ns, message){
   *    ns.tprint(message);
   * }
   * ```
   *
...
/** @public */
declare type CodingContractSignatures = {
...
/** @public */
declare type CodingContractObject = {
...
declare interface Corporation extends WarehouseAPI, OfficeAPI {
   ...
   *
   * Possible states are START, PURCHASE, PRODUCTION, declare, SALE.
   *
   * @example
   * ```js
   * while (true) {
...
/** @public */
type CorpStateName = "START" | "PURCHASE" | "PRODUCTION" | "declare" | "SALE";
...
/**
 * declare order for a material
 * @public
 */
interface declare {
  /** Division the material is being declareed to */
  division: string;
  /** City the material is being declareed to */
  city: CityName;
  /** Amount of material declareed */
  amount: string;
}
 ...
 */
declare type PlayerRequirement =
  | MoneyRequirement
  | SkillRequirement
  | KarmaRequirement
